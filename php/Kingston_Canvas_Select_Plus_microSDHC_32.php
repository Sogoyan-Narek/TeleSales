...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Карта памяти-Kingston Canvas Select</p>
      <hr>
    </div>
    <div class="container">
  ...
  <script id="catalog-template" type="text/template">
    <% _.each(goods, function(good) { %>
        <li class="good-item row">
            <div class="col-md-4">
                <img class="good-item__img" src="<%- good.Kingston_Canvas_Select.img %>" />
            </div>
            <div class="col-md-8">
                <a class="good-item__id" href="/product/<%= good.Kingston_Canvas_Select.id %>">Артикул <%= good.Kingston_Canvas_Select.id %></a>
                <div class="good-item__name"><%- good.Kingston_Canvas_Select.name %></div>
                <div class="good-item__price"><%= good.Kingston_Canvas_Select.price %> руб.</div>
                <button 
                    class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                    data-id="<%= good.Kingston_Canvas_Select.id %>"
                    data-name="<%- good.Kingston_Canvas_Select.name %>"
                    data-price="<%= good.Kingston_Canvas_Select.price %>"
