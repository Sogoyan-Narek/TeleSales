  ...
  <script id="catalog-template" type="text/template">
    <% _.each(goods, function(good) { %>
        <li class="good-item row">
            <div class="col-md-4">
                <img class="good-item__img" src="<%- good.SanDisk_Ultra_microSDXC_128.img %>" />
            </div>
            <div class="col-md-8">
                <a class="good-item__id" href="/product/<%= good.SanDisk_Ultra_microSDXC_128.id %>">Артикул <%= good.SanDisk_Ultra_microSDXC_128.id %></a>
                <div class="good-item__name"><%- good.SanDisk_Ultra_microSDXC_128.name %></div>
                <div class="good-item__price"><%= good.SanDisk_Ultra_microSDXC_128.price %> руб.</div>
                <button 
                    class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                    data-id="<%= good.SanDisk_Ultra_microSDXC_128.id %>"
                    data-name="<%- good.SanDisk_Ultra_microSDXC_128.name %>"
                    data-price="<%= good.SanDisk_Ultra_microSDXC_128.price %>"
