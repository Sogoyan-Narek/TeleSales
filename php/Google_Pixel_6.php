...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Смартфон-Google Pixel 6</p>
      <hr>
    </div>
    <div class="container">
...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.Google_Pixel_6.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.HUAWEI_P_smart_2021.id %>">Артикул <%= good.Google_Pixel_6.id %></a>
              <div class="good-item__name"><%- good.Google_Pixel_6.name %></div>
              <div class="good-item__price"><%= good.Google_Pixel_6.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.Google_Pixel_6.id %>"
                  data-name="<%- good.Google_Pixel_6.name %>"
                  data-price="<%= good.Google_Pixel_6.price %>"
