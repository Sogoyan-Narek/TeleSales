...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Смартфон-Realme 8</p>
      <hr>
    </div>
    <div class="container">
...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.Realme_8.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.Realme_8.id %>">Артикул <%= good.Realme_8.id %></a>
              <div class="good-item__name"><%- good.Realme_8.name %></div>
              <div class="good-item__price"><%= good.Realme_8.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.Realme_8.id %>"
                  data-name="<%- good.Realme_8.name %>"
                  data-price="<%= good.Realme_8.price %>"
