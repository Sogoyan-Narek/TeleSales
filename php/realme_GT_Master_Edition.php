...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Смартфон-Realme GT Master Edition</p>
      <hr>
    </div>
    <div class="container">
    <ul id="goods" class="list-unstyled">
      <img src="img/loading.gif" alt="" width="50px" height="50px"/>
  </ul>
</div>
...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.realme.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.realme.id %>">Артикул <%= good.realme.id %></a>
              <div class="good-item__name"><%- good.realme.name %></div>
              <div class="good-item__price"><%= good.realme.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.realme.id %>"
                  data-name="<%- good.realme.name %>"
                  data-price="<%= good.realme.price %>"
  ...
  <% }); %>
    ...
    <div class="specifications">
      ...
      <div class="specifications-name-div">
        <li> Модель: realme GT Master Edition</li>
      </div>
      <div class="specifications-name-div">
      ...
      <div class="specifications-name-div">
        <li> Материал корпуса: пластик</li>  </div>
        <div class="specifications-name-div">
          <li>Защищенность: олеофобное покрытие</li>
        </div>
        ...
        <div class="specifications-name-div">
          <li> Модель процессора: Snapdragon 778G</li>
        </div>
        <div class="specifications-name-div">
          <li> Количество ядер: 8</li>
        </div>
        <div class="specifications-name-div">
          <li> Частота работы процессора: 1.8 ГГц, 2.4 ГГц</li>
        </div>
        <div class="specifications-name-div">
          <li> Конфигурация процессора: 1x Kryo 670 (Cortex-A78) 2.4 ГГц, 3x Kryo 670 (Cortex-A78) 2.2 ГГц, 4x Kryo 670
            (Cortex-A55) 1.9 ГГц</li>
        </div>
        <div class="specifications-name-div">
          <li> Техпроцесс: 6 нм</li>
        </div>
        <div class="specifications-name-div">
          <li> Графический ускоритель: Adreno 642L</li>
        </div>
        <div class="specifications-name-div">
        ...
        <div class="specifications-name-div">
          <li>Емкость аккумулятора: 4300 мА*ч</li>
        </div>
        <div class="specifications-name-div">
          <li>Съемный аккумулятор: нет</li>
        </div>
        <div class="specifications-name-div">
          <li>Выходная мощность ЗУ: 65 Вт</li>
        </div>
        <div class="specifications-name-div">
          <li>Поддержка быстрой зарядки: Quick Charge 2.0, SuperDart Charge 65W, Power Delivery 2.0</li>
        </div>
        <div class="specifications-name-div">
          <li>Время работы в режиме ожидания: 423 ч</li>
        </div>
        <div class="specifications-name-div">
          <li>Время работы в режиме разговора: 33.7 ч</li>
        </div>
        <div class="specifications-name-div">
          <li>Время работы при прослушивании музыки: 95.1 ч</li>
        </div>
        <div class="specifications-name-div">
          <li>Время работы при воспроизведении видео: 22.2 ч</li>
        </div>
      </div>
      <hr>
