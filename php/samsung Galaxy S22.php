...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Смартфон-Samsung Galaxy S22</p>
      <hr>
    </div>
    <div class="container">
...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.Samsung_Galaxy_S22.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.Samsung_Galaxy_S22.id %>">Артикул <%= good.Samsung_Galaxy_S22.id %></a>
              <div class="good-item__name"><%- good.Samsung_Galaxy_S22.name %></div>
              <div class="good-item__price"><%= good.Samsung_Galaxy_S22.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.Samsung_Galaxy_S22.id %>"
                  data-name="<%- good.Samsung_Galaxy_S22.name %>"
                  data-price="<%= good.Samsung_Galaxy_S22.price %>"
  ...
  <% }); %>
    ...
    <div class="specifications">
      ...
      <div class="specifications-name-div">
        <li> Страна-производитель: Корея, республика</li>
      </div>
      <div>
      ...
      <div class="specifications-name-div">
        <li> Модель: Samsung Galaxy S22</li>
      </div>
      <div class="specifications-name-div">
      ...
      <div class="specifications-name-div">
        ...
        <div class="specifications-name-div">
          <li> Производитель процессора: Samsung</li>
        </div>
        <div class="specifications-name-div">
          <li> Модель процессора: Exynos 2200</li>
        </div>
        <div class="specifications-name-div">
          <li> Количество ядер: 8</li>
        </div>
        <div class="specifications-name-div">
          <li> Конфигурация процессора: 11x Cortex-X2, 4x Cortex-A510, 3x Cortex-A710</li>
        </div>
        <div class="specifications-name-div">
          <li> Техпроцесс: 4 нм</li>
        </div>
        <div class="specifications-name-div">
          <li> Графический ускоритель: Samsung Xclipse 920</li>
        </div>
        <div class="specifications-name-div">
        ...
        <div class="specifications-name-div">
          <li>Емкость аккумулятора: 3700 мА*ч</li>
        </div>
        <div class="specifications-name-div">
          <li>Съемный аккумулятор: нет</li>
        </div>
        <div class="specifications-name-div">
          <li>Выходная мощность ЗУ: 25 Вт</li>
        </div>
        <div class="specifications-name-div">
