...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.Xiaomi_Redmi_Note_10_Pro.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.Xiaomi_Redmi_Note_10_Pro.id %>">Артикул <%= good.Xiaomi_Redmi_Note_10_Pro.id %></a>
              <div class="good-item__name"><%- good.Xiaomi_Redmi_Note_10_Pro.name %></div>
              <div class="good-item__price"><%= good.Xiaomi_Redmi_Note_10_Pro.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.Xiaomi_Redmi_Note_10_Pro.id %>"
                  data-name="<%- good.Xiaomi_Redmi_Note_10_Pro.name %>"
                  data-price="<%= good.Xiaomi_Redmi_Note_10_Pro.price %>"
