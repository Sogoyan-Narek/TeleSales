...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.Realme_9_pro.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.Realme_9_pro.id %>">Артикул <%= good.Realme_9_pro.id %></a>
              <div class="good-item__name"><%- good.Realme_9_pro.name %></div>
              <div class="good-item__price"><%= good.Realme_9_pro.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.Realme_9_pro.id %>"
                  data-name="<%- good.Realme_9_pro.name %>"
                  data-price="<%= good.Realme_9_pro.price %>"
