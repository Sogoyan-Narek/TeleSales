...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Смартфон-Infinix HOT 20S</p>
      <hr>
    </div>
    <div class="container">
...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.Infinix_HOT_20S.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.Infinix_HOT_20S.id %>">Артикул <%= good.Infinix_HOT_20S.id %></a>
              <div class="good-item__name"><%- good.Infinix_HOT_20S.name %></div>
              <div class="good-item__price"><%= good.Infinix_HOT_20S.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.Infinix_HOT_20S.id %>"
                  data-name="<%- good.Infinix_HOT_20S.name %>"
                  data-price="<%= good.Infinix_HOT_20S.price %>"
