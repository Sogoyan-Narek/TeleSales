...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.Samsung_Galaxy_A13.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.Samsung_Galaxy_A13.id %>">Артикул <%= good.Samsung_Galaxy_A13.id %></a>
              <div class="good-item__name"><%- good.Samsung_Galaxy_A13.name %></div>
              <div class="good-item__price"><%= good.Samsung_Galaxy_A13.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.Samsung_Galaxy_A13.id %>"
                  data-name="<%- good.Samsung_Galaxy_A13.name %>"
                  data-price="<%= good.Samsung_Galaxy_A13.price %>"
