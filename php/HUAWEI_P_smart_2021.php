...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Смартфон-Huawei P smart 2021</p>
      <hr>
    </div>
    <div class="container">
...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.HUAWEI_P_smart_2021.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.HUAWEI_P_smart_2021.id %>">Артикул <%= good.HUAWEI_P_smart_2021.id %></a>
              <div class="good-item__name"><%- good.HUAWEI_P_smart_2021.name %></div>
              <div class="good-item__price"><%= good.HUAWEI_P_smart_2021.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.HUAWEI_P_smart_2021.id %>"
                  data-name="<%- good.HUAWEI_P_smart_2021.name %>"
                  data-price="<%= good.HUAWEI_P_smart_2021.price %>"
