...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Карта памяти-Samsung EVO Plus microSDXC 64</p>
      <hr>
    </div>
    <div class="container">
  ...
  <script id="catalog-template" type="text/template">
    <% _.each(goods, function(good) { %>
        <li class="good-item row">
            <div class="col-md-4">
                <img class="good-item__img" src="<%- good.Samsung_EVO_Plus_microSDXC_64.img %>" />
            </div>
            <div class="col-md-8">
                <a class="good-item__id" href="/product/<%= good.Samsung_EVO_Plus_microSDXC_64.id %>">Артикул <%= good.Samsung_EVO_Plus_microSDXC_64.id %></a>
                <div class="good-item__name"><%- good.Samsung_EVO_Plus_microSDXC_64.name %></div>
                <div class="good-item__price"><%= good.Samsung_EVO_Plus_microSDXC_64.price %> руб.</div>
                <button 
                    class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                    data-id="<%= good.Samsung_EVO_Plus_microSDXC_64.id %>"
                    data-name="<%- good.Samsung_EVO_Plus_microSDXC_64.name %>"
                    data-price="<%= good.Samsung_EVO_Plus_microSDXC_64.price %>"
