...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Смартфон-Wiko 10</p>
      <hr>
    </div>
    <div class="container">
...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.Wiko_10.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.Wiko_10.id %>">Артикул <%= good.Wiko_10.id %></a>
              <div class="good-item__name"><%- good.Wiko_10.name %></div>
              <div class="good-item__price"><%= good.Wiko_10.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.Wiko_10.id %>"
                  data-name="<%- good.Wiko_10.name %>"
                  data-price="<%= good.Wiko_10.price %>"
