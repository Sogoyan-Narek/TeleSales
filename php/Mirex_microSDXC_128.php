...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Карта памяти-Mirex microSDXC</p>
      <hr>
    </div>
    <div class="container">
  ...
  <script id="catalog-template" type="text/template">
    <% _.each(goods, function(good) { %>
        <li class="good-item row">
            <div class="col-md-4">
                <img class="good-item__img" src="<%- good.Mirex_microSDXC_128.img %>" />
            </div>
            <div class="col-md-8">
                <a class="good-item__id" href="/product/<%= good.Mirex_microSDXC_128.id %>">Артикул <%= good.Mirex_microSDXC_128.id %></a>
                <div class="good-item__name"><%- good.Mirex_microSDXC_128.name %></div>
                <div class="good-item__price"><%= good.Mirex_microSDXC_128.price %> руб.</div>
                <button 
                    class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                    data-id="<%= good.Mirex_microSDXC_128.id %>"
                    data-name="<%- good.Mirex_microSDXC_128.name %>"
                    data-price="<%= good.Mirex_microSDXC_128.price %>"
