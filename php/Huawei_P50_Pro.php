...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Смартфон-Huawei P50 Pro</p>
      <hr>
    </div>
    <div class="container">
...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.Huawei_P50_Pro.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.Huawei_P50_Pro.id %>">Артикул <%= good.Huawei_P50_Pro.id %></a>
              <div class="good-item__name"><%- good.Huawei_P50_Pro.name %></div>
              <div class="good-item__price"><%= good.Huawei_P50_Pro.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.Huawei_P50_Pro.id %>"
                  data-name="<%- good.Huawei_P50_Pro.name %>"
                  data-price="<%= good.Huawei_P50_Pro.price %>"
