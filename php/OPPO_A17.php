...
<body data-page="catalog">
  ...
  <main>
    <div>
      <p class="breadcrumbs">Смартфон-OPPO A17K</p>
      <hr>
    </div>
    <div class="container">
...
<script id="catalog-template" type="text/template">
  <% _.each(goods, function(good) { %>
      <li class="good-item row">
          <div class="col-md-4">
              <img class="good-item__img" src="<%- good.OPPO_A17.img %>" />
          </div>
          <div class="col-md-8">
              <a class="good-item__id" href="/product/<%= good.OPPO_A17.id %>">Артикул <%= good.OPPO_A17.id %></a>
              <div class="good-item__name"><%- good.OPPO_A17.name %></div>
              <div class="good-item__price"><%= good.OPPO_A17.price %> руб.</div>
              <button 
                  class="good-item__btn-add btn btn-info btn-sm js-add-to-cart"
                  data-id="<%= good.OPPO_A17.id %>"
                  data-name="<%- good.OPPO_A17.name %>"
                  data-price="<%= good.OPPO_A17.price %>"
